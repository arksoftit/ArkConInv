--
-- Archivo generado con SQLiteStudio v3.4.17 el mar jun. 23 14:22:05 2026
--
...
CREATE TABLE IF NOT EXISTS ark_depositos (
    ...
    REFERENCES ark_unds_operativas (uo_id) 
);


-- Tabla: ark_detalletrancomp
DROP TABLE IF EXISTS ark_detalletrancomp;

CREATE TABLE IF NOT EXISTS ark_detalletrancomp (
    dtc_Idauto                     INTEGER PRIMARY KEY AUTOINCREMENT,
    dtc_idunico                    TEXT    UNIQUE ON CONFLICT ABORT
    ...
    dtc_detallecostosimportacion   TEXT,
    dtc_detalleplanillaimportacion TEXT,
    dtc_existedetalleimportacion   INTEGER,
    ...
    REFERENCES ark_inventario (inv_codigo) 
);


-- Tabla: ark_detalletraninv
DROP TABLE IF EXISTS ark_detalletraninv;

CREATE TABLE IF NOT EXISTS ark_detalletraninv (
    dti_Idauto                     INTEGER PRIMARY KEY AUTOINCREMENT,
    dti_idunico                    TEXT    UNIQUE ON CONFLICT ABORT
                                           NOT NULL ON CONFLICT ABORT,
    ...
    dti_detallecostosimportacion   TEXT,
    dti_detalleplanillaimportacion TEXT,
    dti_existedetalleimportacion   INTEGER,
...
-- Tabla: ark_detalletranvtas
DROP TABLE IF EXISTS ark_detalletranvtas;

CREATE TABLE IF NOT EXISTS ark_detalletranvtas (
    dtv_Idauto                     INTEGER PRIMARY KEY AUTOINCREMENT,
    dtv_idunico                    TEXT    UNIQUE ON CONFLICT ABORT
                                           NOT NULL ON CONFLICT ABORT,
    ...
    dtv_detallecostosimportacion   TEXT,
    dtv_detalleplanillaimportacion TEXT,
    dtv_existedetalleimportacion   INTEGER,
...
-- Tabla: ark_inventario
DROP TABLE IF EXISTS ark_inventario;

CREATE TABLE IF NOT EXISTS ark_inventario (
    inv_IDauto                    INTEGER PRIMARY KEY AUTOINCREMENT,
    inv_codigo                    TEXT    NOT NULL ON CONFLICT ROLLBACK
    ...
    REFERENCES ark_categoria (cat_IDauto) 
);


-- Tabla: ark_status_operacion
DROP TABLE IF EXISTS ark_status_operacion;
...
-- Tabla: ark_tipos_operacion
DROP TABLE IF EXISTS ark_tipos_operacion;
...
-- Tabla: ark_transacciones
DROP TABLE IF EXISTS ark_transacciones;

CREATE TABLE IF NOT EXISTS ark_transacciones (
    trn_Idauto                    INTEGER PRIMARY KEY AUTOINCREMENT,
    trn_idunico                   TEXT    UNIQUE ON CONFLICT ABORT
                                          NOT NULL ON CONFLICT ABORT,
...
CREATE TABLE IF NOT EXISTS ark_unds_operativas (
    ...
    REFERENCES ark_company (com_IDauto) 
);
