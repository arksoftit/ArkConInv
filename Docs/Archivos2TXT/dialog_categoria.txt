...
class DialogCategoria(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.title("Maestro de Categorías")
    ...
    def _cargar_datos(self):
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute("SELECT cat_IDauto, cat_codigo, cat_descripcion, cat_status FROM ark_categoria")
