...
class DialogDeposito(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.title("Maestro de Depósitos")
    ...
    def _cargar_datos(self):
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute("SELECT dep_IDauto, dep_codigo, dep_descripcion, dep_status FROM ark_depositos")
            ...
            print(f"Error al cargar depósitos: {e}")
