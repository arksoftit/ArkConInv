...
CREATE TABLE IF NOT EXISTS ark_periodos (
    ...
    pdo_inv_declarado_ini_l REAL DEFAULT 0.0,
    pdo_inv_declarado_fin_l REAL DEFAULT 0.0,
    pdo_inv_declarado_ini_r REAL DEFAULT 0.0,
    pdo_inv_declarado_fin_r REAL DEFAULT 0.0,
