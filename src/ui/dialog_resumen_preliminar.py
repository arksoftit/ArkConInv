...
from core.generar_pdf import generar_pdf_resumen_preliminar


class DialogResumenPreliminar(tk.Toplevel):
    ...
    def _generar_pdf(self):
        try:
            ...
            ruta_salida = filedialog.asksaveasfilename(
                ...
                initialfile="Reporte_Resumen_Preliminar_Inventario.pdf"
            )
            ...
            generar_pdf_resumen_preliminar(
